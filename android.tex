...
Mit Clients (z.B. dem adb command line tool, oder IDEs wie Android Studio), verbinden sich mit dem Server und senden Befehle an das über USB (oder Wifi)(oder Wifi)  mit dem Server verbundene Endgerät.
...
was es Clients ermöglicht sich über das Netzwerk mit Servern zu verbinden.
